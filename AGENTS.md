...
pnpm desktop:dev                    # Electron desktop shell over dsh web (Windows)
pnpm desktop:test:e2e               # desktop real-composition smoke (needs built CLI + frontend)
pnpm desktop:pack                   # Windows x64 NSIS installer (mirrors first)
