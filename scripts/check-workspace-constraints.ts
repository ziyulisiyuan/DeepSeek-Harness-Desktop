...
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  ...
  // Private desktop shell: the built main plus its packaging scripts and
  // builder config; never published, listed so the policy stays explicit.
  '@deepseek-ai/dsh-desktop': ['lib/main.js', 'scripts', 'electron-builder.yml'],
}
